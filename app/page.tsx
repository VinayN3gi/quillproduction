  ...
  return (
    ...
    <MaxWidthWrapper className=' mb-12 mt-14 sm:mt-30 justify-center items-center flex flex-col text-center'>
      ...
      <p className=' mt-5 max-w-prose  text-zinc-700 sm:text-lg'>
        Quill is a chat app that lets you chat with your documents in real-time. 
        It's like Google Docs, but with a chat feature built-in. 
        You can create a new document, share it with your friends, and start chatting in seconds.
      </p>
    ...
    <div>
        <div className=' relative isolate'>
            <div  aria-hidden="true" className=' pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:top-80'>
              ...
              }} className=' relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -transalte-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-40 sm:left[calc(50%-30rem)] sm:w-[72.1875rem ]'/>
            </div>
            <div className=' mx-auto max-w-6xl px-6 lg:px-8'> 
                <div className=' mt-16 flow-root sm:mt-24'>
                     <div className= ' ring-gray-900/10 -m-2 rounded-lg bg-gray-900/5 p-2 ring-1 ring-inset  lg:-m-4 lg:rounded-2xl lg:p-4'>
                        <Image src="/dashboard-preview.jpg" alt="Dashboard image" width="1364" height="866"
            ...
            <div  aria-hidden="true" className=' pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:top-80'>
              <div style ={{
                clipPath: 'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)'
              }} className=' relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -transalte-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-40 sm:left[calc(50%-36rem)] sm:w-[72.1875rem ]'/>
            </div>
            </div>
        </div>
    </div>
        ...
        <div className=' mb-12 px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl sm:text-center'>
                ...
                <p className=' mt-4 text-lg text-gray-600'>
                    Chatting to your pdf has never been easier. With Quill, you can chat with your documents in real-time.
                </p>
            </div>
        </div>
